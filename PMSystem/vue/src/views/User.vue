...
export default {
  ...
  methods: {
    ...
    load() {
      ...
      /*      fetch("http://localhost:9090/user/page?pageNumber="+this.pageNumber+"&pageSize="+this.pageSize+"&userName="+this.userName+"&email="+this.email+"&address"+this.address).then(res => res.json()).then(res => {
              console.log(res);
              this.tableData = res.records;
              this.total = res.total;
            })*/
